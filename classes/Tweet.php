...
class Tweet{
	...
	{
		$announce = array("ごめんね、残念だけど部室の使用禁止なんだ(´・ω・`)",
			array("ごめんなさい、部室の使用禁止なんです。。。でもこれで私と一緒にいてくれますよね。。。？ねえ、おにいさん。。。",
		...
		$req = self::$tweet->OAuthRequest("https://api.twitter.com/1.1/statuses/update.json","POST",array("status"=>$sister_announce));	
	}

	public function WeatherNews($sister, $time) //天気予報
	{
		$message = array("08時30分" => array("本日の天気予報ヽ(*´∀｀*)ノ",
											"本日の天気予報ですよ( ´艸｀)",
											"今日の天気だよ！！(*｀･ω･)ゞ",
											"本日の天気予報ですわ(๑˃́ꇴ˂̀๑)"),
						"22時30分" => array("明日の天気予報ヽ(*´∀｀*)ノ",
											"明日の天気予報ですよ( ´艸｀)",
											"明日の天気だよ！！(*｀･ω･)ゞ",
											"明日の天気予報ですわ(๑˃́ꇴ˂̀๑)")); //セリフの拡張性を考えて時間毎に配列の要素としてセリフを格納
		...
		$end = array("08時30分" => array("以上、メイの天気予報でした!",
					...
					"22時30分" => array("以上、メイの天気予報でした!明日もいい1日でありますように",
	...
	public function TweetMorningMessage($sister) //8時のあいさつ
	{
		...
		if(empty($holiday_checker)){
			$announce = array("おにいちゃん!!今日は休日日程だから気をつけてね!!\n2限は10:20から、昼は11:40から開始だよ!!",
			...
			$announce = array(array("おにいちゃんおはよう!!今日も一日がんばろうね!!(oﾟ▽ﾟ)o",
									"おにいちゃん、起きてる？ヾ(･∀･`o)",
									"ふああ。。。おは。。。おはよう。。。Oo｡(｡p ω-｡)zzz",
									"にゃー!!(●ↀωↀ●)✧",
									"練習は進んでるかな?気を引き締めていこうね!!(｀・ω・´)"),
							array("おにいさんおはようございます!!今日も一日がんばりましょう!!(oﾟ▽ﾟ)o",
							...
							array("おにいちゃんおはよう!!今日も一日がんばるよ!!(oﾟ▽ﾟ)o",
								"おにいちゃん、起きなきゃダメだよ？",
								"おにいちゃん、起きて〜。。。もう!!!起きろーーーー!!!",
								"おっはよーーーー!!!",
								"練習は進んでる?気を引き締めていかなきゃだね!!(｀・ω・´)"),
							array("おにいさまおはようございます。今日も一日がんばりますわよ!!(oﾟ▽ﾟ)o",
	...
	public function TweetAvailableRoomToday($sister, $time) //その日の部室の空き状況（メイン機能）
	{
		...
		$announce = array(array("現在の部室の空き状況を教えるね！！",
	...
	{
		$announce = array(array("おにいちゃん!!明日の部室の空き状況を教えるね!!",
								"おにいちゃん!!明日は休日日程だから気をつけてね!!\n2限は10:20から\n昼は11:40から\n4限は14:20から\n5限は15:40から開始だよ!!"),
							array("おにいさん、明日の部室の空き状況です。",
								"おにいさん、明日は休日日程ですよ〜。\n2限は10:20から\n昼は11:40から\n4限は14:20から\n5限は15:40から開始ですからね!!"),
							array("おにいちゃん、明日の部室の空き状況だよ!!",
								"おにいちゃん、明日は休日日程だからね!!\n2限は10:20から\n昼は11:40から\n4限は14:20から\n5限は15:40から開始だからね!!"),
							array("おにいさま、明日の部室の空き状況ですわ。",
								"おにいさま、明日は休日日程ですわ。\n2限は10:20から\n昼は11:40から\n4限は14:20から\n5限は15:40から開始ですわ。")
							); //共通のつぶやき
